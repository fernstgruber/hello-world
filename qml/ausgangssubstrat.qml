...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="KZ_sgng">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Bschrb_">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="Bschrb_" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Blockschutt" label="Blockschutt"/>
      <category render="true" symbol="1" value="Deponien, Aufschuettungen" label="Deponien, Aufschuettungen"/>
      <category render="true" symbol="2" value="Hangschutt, prinzipiell material von oben" label="Hangschutt, prinzipiell material von oben"/>
      <category render="true" symbol="3" value="Kalk- und Dolomitgestein" label="Kalk- und Dolomitgestein"/>
      <category render="true" symbol="4" value="Kies,Schutt,Sand" label="Kies,Schutt,Sand"/>
      <category render="true" symbol="5" value="Moraenenmaterial" label="Moraenenmaterial"/>
      <category render="true" symbol="6" value="Organisches Substrat" label="Organisches Substrat"/>
      <category render="true" symbol="7" value="Sandstein, Konglomerate und Brekzien" label="Sandstein, Konglomerate und Brekzien"/>
      <category render="true" symbol="8" value="Silikatgestein" label="Silikatgestein"/>
      <category render="true" symbol="9" value="Wasserflaeche" label="Wasserflaeche"/>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="162,177,172,255"/>
      ...
      <symbol alpha="0" type="fill" name="10">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
      ...
      <symbol alpha="0.921569" type="fill" name="8">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="187,238,167,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
